...
# Courses: colt_py_bootcamps    248, 251, 252

# -----------------    OOP Exercise    -----------------
	# Introduction: Your goal in this exercise is to implement two classes, "Card" and "Deck" .
	...
	# Deck:
		...
		# 4.	'Deck' should have an instance method called '_deal' which accepts a number and removes at most that many cards from the deck 
		...
		# 7.	'Deck' should have an instance method called "deal_hand" which accepts a number and uses the '_deal' 
		# 	method to deal a list of cards from the deck and return that list of cards.
